...
int main(int argc, char **argv)
{
	if (argc<3 || argc>=5)
	{
		//8ewrw oti an parw panw apo 3 arxeia san orisma tupwnw to mnm kai teleiwnw
	...
	else
	{
		...
		//an exw trito orisma xrhsimopoiw auto to arxeio gia na grapsw to apotelesma
		if (strcmp(argv[1], argv[3]) == 0) printf("You can't give arguments A B A\n");
		else if(strcmp(argv[2],argv[3])== 0) printf("You can't give arguments A B B\n");
